...
function KeyMeasure({ value, index }) {
  ...
  return (
    <input
      ...
      name="key-measure"
      value={keyMeasure}
      onChange={(e) => setKeyMeasure(e.target.value)}
      required
    />
  );
}
...
function ObjectiveBox({ obj, windowWidth }) {
  ...
  const updateMessageClass =
    "update-message " + (updateMessageShow ? "update-message-show" : "");
  const keyEmptyMessage =
    "emptyField-message " + (keyMsgShow ? "emptyField-message-show" : "");
        ...
        <div className="keyMeasure-field">
          ...
          <div className="keyMeasure-head">
            ...
            <div className="addKey-btn" onClick={addkeyMeasureField}>
              <p>
                {windowWidth > 400 ? `Add additional key measure` : `Add key`}
              </p>
  ...
  return (
    <div className="main-body">
      ...
      <div className="body-link-div">
        ...
        <h4 className="body-link page-active-link">
